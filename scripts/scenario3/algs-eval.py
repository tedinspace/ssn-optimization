...
#AGENT = "q-table"
#with open(BASE_PATH+"agent-q-table-S3.pkl", "rb") as f:
...
env = Environment(sensor_keys, sat_keys, randomizer=Randomizer(scenario_length_hrs=[24,24], maneuver_details=["type1", [2,2], [1,2], [0.5,11]])) 
