...
IS_DQN = True
AGENT = "DQN"
with open(BASE_PATH+"agent-DQN-S2.pkl", "rb") as f:
...
env = Environment(sensor_keys, sat_keys, randomizer=Randomizer(scenario_length_hrs=[12,12], maneuver_details=["type1", [1,1], [1,2], [0.5,11]])) 
